          ...
          <div className="mb-6">
                    ...
                    <tr key={part.id}>
                      ...
                      <td className="px-3 py-2">
                        <input
                          ...
                          onChange={(e) => handlePartChange(part.id, 'orderQuantity', parseInt(e.target.value) || 0)}
                          required
                        />
                      </td>
                      <td className="px-3 py-2">
                        <input
                          ...
                          onChange={(e) => handlePartChange(part.id, 'receivingQuantity', parseInt(e.target.value) || 0)}
                          required
                        />
                      </td>
                      <td className="px-3 py-2">
                        <div className="flex items-center justify-center space-x-2">
                          <input
                            ...
                            onChange={(e) => handlePartChange(part.id, 'isSerial', e.target.checked)}
                          ...
                          {part.isSerial && (
                            <input
                              ...
                              onChange={(e) => handlePartChange(part.id, 'serialNumber', e.target.value)}
                            />
                          )}
                        </div>
                      </td>
            ...
            <div className="mt-4 bg-blue-50 p-3 rounded-md flex items-start">
              ...
              <p className="text-sm text-blue-700">
                Please verify all part numbers and quantities before confirming receipt. 
                Mark any damaged items with the "Damaged" status and add notes about the condition.
              </p>
            </div>
          </div>
