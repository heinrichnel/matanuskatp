              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold text-green-700">
                    {formatCurrency(financials.revenueSummary.totalRevenue, financials.revenueSummary.currency)}
                  </p>
                </div>
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold text-red-700">
                    {formatCurrency(financials.costBreakdown.totalCosts, financials.revenueSummary.currency)}
                  </p>
                </div>
                      ...
                      <div className="w-full">
                        <div className="flex justify-between mb-1">
                          ...
                          <span className="text-sm font-medium text-gray-700">
                            {formatCurrency(value, financials.revenueSummary.currency)} ({percentage}%)
                          </span>
                        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-green-50 p-3 rounded-lg">
                  ...
                  <p className="text-lg font-bold text-green-900">
                    {formatCurrency(financials.perKmMetrics.profitPerKm, financials.revenueSummary.currency)}
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-xs font-medium text-gray-800">
                        {formatCurrency(financials.perKmMetrics.costPerKm, financials.revenueSummary.currency)}/km
                      </span>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-xs font-medium text-gray-800">
                        {formatCurrency(financials.comparisonMetrics?.companyAvgCostPerKm || 0, financials.revenueSummary.currency)}/km
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-1.5">
                      <div
                  ...
                  <div>
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-xs font-medium text-gray-800">
                        {formatCurrency(financials.comparisonMetrics?.industryAvgCostPerKm || 0, financials.revenueSummary.currency)}/km
                      </span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-1.5">
                      <div
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <ul className="space-y-1 text-sm text-blue-700">
                  <li><strong>Gross Profit:</strong> {formatCurrency(financials.profitAnalysis.grossProfit, financials.revenueSummary.currency)}</li>
                  <li><strong>Gross Margin:</strong> {financials.profitAnalysis.grossProfitMargin.toFixed(1)}%</li>
                  <li><strong>Net Profit:</strong> {formatCurrency(financials.profitAnalysis.netProfit, financials.revenueSummary.currency)}</li>
                  <li><strong>Net Margin:</strong> {financials.profitAnalysis.netProfitMargin.toFixed(1)}%</li>
                  <li><strong>Return on Investment:</strong> {financials.profitAnalysis.returnOnInvestment.toFixed(1)}%</li>
                </ul>
              </div>
              <div>
                ...
                <p className="text-sm text-blue-700">
                  {financials.comparisonMetrics?.variance && financials.comparisonMetrics.variance < 0
            ...
            <div className="space-y-2">
              {financials.costBreakdown.fuelCosts / financials.costBreakdown.totalCosts > 0.35 && (
                <div className="flex items-start">
                  ...
                  <p className="text-sm text-gray-700">
                    <strong>Optimize Fuel Consumption:</strong> Fuel costs are higher than optimal. Consider route optimization or driver training to reduce consumption.
                  </p>
                </div>
              )}
              ...
              {financials.comparisonMetrics?.variance && financials.comparisonMetrics.variance > 10 && (
                <div className="flex items-start">
                  ...
                  <p className="text-sm text-gray-700">
                    <strong>Cost Analysis Needed:</strong> This trip's costs are significantly higher than average. Review all cost categories for potential savings.
                  </p>
                </div>
              )}
              ...
              {financials.profitAnalysis.netProfitMargin < 5 && (
                <div className="flex items-start">
                  ...
                  <p className="text-sm text-gray-700">
                    <strong>Pricing Review:</strong> This trip's profit margin is too low. Consider adjusting pricing or negotiating better rates with the client.
                  </p>
                </div>
              )}
              ...
              {financials.profitAnalysis.netProfitMargin > 20 && (
                <div className="flex items-start">
                  ...
                  <p className="text-sm text-gray-700">
                    <strong>Excellent Performance:</strong> This trip shows strong profitability. Consider using this route as a template for future trips.
                  </p>
                </div>
              )}
              ...
              {financials.costBreakdown.borderCosts / financials.costBreakdown.totalCosts > 0.2 && (
                <div className="flex items-start">
                  ...
                  <p className="text-sm text-gray-700">
                    <strong>Border Costs:</strong> Border-related expenses are significant for this trip. Ensure all documentation is properly prepared to avoid delays and additional costs.
                  </p>
                </div>
              )}
            </div>
