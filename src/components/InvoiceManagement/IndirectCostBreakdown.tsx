      ...
      <Card>
        <CardHeader>
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <h3 className="text-lg font-medium">Total Indirect Costs: {formatCurrency(totalIndirectCost)}</h3>
                ...
                <tbody>
                  {costCategories.map((category) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-2 text-right font-medium">{formatCurrency(category.amount)}</td>
                ...
                <table className="min-w-full bg-white">
                  ...
                  <tfoot>
                    <tr className="bg-gray-100 font-medium">
                      ...
                      <td className="px-4 py-2 text-right">{formatCurrency(selectedCategory.amount)}</td>
                      <td className="px-4 py-2 text-center">100%</td>
                    </tr>
                  </tfoot>
                </table>
                ...
                <div className="mt-6">
                  ...
                  <ul className="list-disc pl-5 space-y-1">
                    {selectedCategory.name === 'Administrative' && (
                      <>
                        <li className="text-sm">Consolidate software subscriptions (~15% savings)</li>
                        <li className="text-sm">Negotiate better rates for professional services</li>
                      </>
                    )}
                    ...
                    {selectedCategory.name === 'IT Infrastructure' && (
                      <>
                        ...
                        <li className="text-sm">Consolidate hardware purchases for bulk discounts</li>
                      </>
                    )}
