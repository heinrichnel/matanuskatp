        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400">
              Advanced fleet management system for heavy vehicle operations.
              Track, manage, and optimize your fleet performance.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/forms" className="text-gray-400 hover:text-white">Forms</a></li>
              <li><a href="/fleet" className="text-gray-400 hover:text-white">Fleet Management</a></li>
              <li><a href="/trips" className="text-gray-400 hover:text-white">Trip Planning</a></li>
            </ul>
          </div>
