  ...
  const navCategories: {
      ...
      items: [
        {
          ...
          children: [
            ...
            { id: 'completed-trips', label: 'Completed Trips (Dashboard)', route: 'trips/completed-dashboard' },
            ...
            { id: 'load-confirmation', label: 'New Load Confirmation', route: 'trips/new-load-confirmation' },
...

        {
          ...
          children: [
            ...
            { id: 'invoice-reconciliation', label: 'Invoice Reconciliation', route: 'invoices/reconciliation' },
    ...
    // Workshop Management
    {
      ...
      items: [
        ...
        { id: 'tyre-reference-data', label: 'Tyre Reference Data', route: 'workshop/tyres/reference-data' },
        ...
        { id: 'workshop-integration-debug', label: 'Integration Debug', route: 'integration-debug/workshop' },
      ]
    },
    ...
    // Tyre Management
    {
      ...
      items: [
        ...
        { id: 'tyre-integration-debug', label: 'Integration Debug', route: 'integration-debug/tyres' },
      ]
    },
            ...
            <ul className="space-y-1">
              {category.items.map(({ id, label, icon: Icon, route, children }) => {
                ...
                const isActive = children
                  ? normalizedCurrentView === normalizedRoute || normalizedCurrentView.startsWith(`${normalizedRoute}/`)
