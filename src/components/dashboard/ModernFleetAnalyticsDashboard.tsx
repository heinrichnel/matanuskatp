...
export function ModernFleetAnalyticsDashboard() {
  ...
  const [filterOptions, setFilterOptions] = useState<FilterOption[]>([
    { id: "fuelConsumption", label: "Fuel Consumption", checked: activeFilters.includes("fuelConsumption") },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white dark:bg-gray-800 p-4 rounded-xl shadow">
        <div>
          <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Fleet Analytics Dashboard</h1>
          ...
          <Card key={i} className="border border-gray-200">
            <CardContent className="p-4">
              ...
              <div className="flex items-end justify-between mt-2">
                ...
                <p className={`text-xs font-medium ${stat.up ? 'text-green-500' : 'text-gray-500'}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card className="border border-gray-200 lg:col-span-2">
          <CardHeader heading="Fleet Performance Metrics" subtitle="Key performance indicators over time" />
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {[
                { id: 'V-1001', name: 'Volvo FH16', status: 'Active', utilization: '92%', efficiency: 'High', maintenance: 'Up to date' },
                { id: 'V-1002', name: 'Scania R450', status: 'Active', utilization: '88%', efficiency: 'Medium', maintenance: 'Due in 2 weeks' },
                { id: 'V-1003', name: 'Mercedes Actros', status: 'Maintenance', utilization: '0%', efficiency: 'High', maintenance: 'In progress' },
                { id: 'V-1004', name: 'MAN TGX', status: 'Active', utilization: '95%', efficiency: 'Low', maintenance: 'Due tomorrow' },
                { id: 'V-1005', name: 'DAF XF', status: 'Active', utilization: '79%', efficiency: 'Medium', maintenance: 'Up to date' },
              ].map((vehicle) => (
                <tr key={vehicle.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{vehicle.utilization}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{vehicle.efficiency}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{vehicle.maintenance}</td>
                </tr>
              ))}
            </tbody>
          </table>
