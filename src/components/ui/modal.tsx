...
interface ModalProps {
  isOpen: boolean;
  onClose: () => void;
  title?: string; // Made optional to support all implementations
 ...
 * @param props.title - Title of the modal (optional)
 * @param props.children - Content of the modal
 * @param props.maxWidth - Maximum width of the modal
 * @param props.size - Size of the modal (for backward compatibility)
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
          ref={modalRef}
          className={cn(
            `inline-block w-full ${maxWidthClasses[finalMaxWidth as keyof typeof maxWidthClasses]} p-6 my-8
