...
const TyrePerformanceReport: React.FC = () => {
      ...
      try {
        ...
        const mockData: TyrePerformanceData = {
          ...
          positionAnalysis: [
            ...
            { position: 'Rear Left Outer', averageLifespan: 112000, wearRate: 0.78, failureRate: 0.08 },
            { position: 'Rear Left Inner', averageLifespan: 116000, wearRate: 0.75, failureRate: 0.06 },
            { position: 'Rear Right Inner', averageLifespan: 115000, wearRate: 0.76, failureRate: 0.07 },
            { position: 'Rear Right Outer', averageLifespan: 110000, wearRate: 0.8, failureRate: 0.09 }
          ],
          failureReasons: [
  ...
  const handleExportReport = () => {
    alert('Report export functionality would go here - would generate PDF report with all charts and analysis.');
  };
    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <select
              value={timeFrame}
              onChange={(e) => setTimeFrame(e.target.value as '6months' | '1year' | '2years' | '3years')}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white shadow-md rounded-lg p-6 border-l-4 border-amber-500">
          ...
          <div className="text-3xl font-bold">
            ${performanceData.costAnalysis.reduce((sum, month) => sum + month.total, 0).toLocaleString()}
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Tooltip formatter={(value, name) => {
                  if (name === 'averageMileage') return [`${value.toLocaleString()} km`, 'Average Mileage'];
                  if (name === 'averageCostPerKm') return [`$${value}`, 'Cost per KM'];
                  return [value, name];
                }} />
                <Legend />
                <Bar yAxisId="left" dataKey="averageMileage" name="Average Mileage (km)" fill="#8884d8" />
                <Bar yAxisId="right" dataKey="averageCostPerKm" name="Cost per KM ($)" fill="#82ca9d" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <div className="mt-3 text-sm text-gray-600">
            <p>Analysis: 48% of tyres show even wear patterns, indicating good alignment and pressure maintenance. Center wear (22%) suggests over-inflation issues.</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Tooltip />
                <Legend />
                <Bar yAxisId="left" dataKey="averageLifespan" name="Avg. Lifespan (km)" fill="#8884d8" />
          ...
          <div className="mt-3 text-sm text-gray-600">
            <p>Analysis: Front position tyres have shorter lifespans and higher wear rates compared to rear inner positions. Consider rotation strategies to optimize overall tyre life.</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          ...
          <div className="mt-3 text-sm text-gray-600">
            <p>Analysis: Punctures account for 34% of tyre failures, suggesting a need for better road hazard avoidance training and possibly more puncture-resistant tyres.</p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-gray-600">Winter shows 15% higher wear rates and 100% higher failure rates. Schedule major tyre replacements before winter and consider specialized winter compounds for critical routes.</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-blue-700">
              This report analyses {performanceData.brandComparison.reduce((sum, brand) => sum + brand.count, 0)} tyres across {performanceData.vehicleComparison.length} vehicles over the selected time period. For more detailed analysis, export the full report or adjust the time frame.
            </p>
          </div>
        </div>
      </div>
