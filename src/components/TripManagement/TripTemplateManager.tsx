            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Est. Distance</th>
        ...
        <CardContent className="p-6">
          <div className="h-64 flex items-center justify-center">
            <p className="text-gray-500 italic">
              Template usage statistics visualization would be displayed here.
              Charts showing frequently used templates and trends.
            </p>
          </div>
        </CardContent>
      </Card>
