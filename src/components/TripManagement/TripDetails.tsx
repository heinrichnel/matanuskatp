...
const TripDetails: React.FC<TripDetailsProps> = ({ trip, onBack }) => {
  ...
  const wialonStatus = hasWialonTracking ? 'Connected to Wialon Unit ID: ' + trip.fleetUnitId : 'Not connected to Wialon';

  // Display unit info
  const wialonUnitDisplay = trip.fleetUnitId ? `Unit ID: ${trip.fleetUnitId}` : 'No tracking unit connected';
