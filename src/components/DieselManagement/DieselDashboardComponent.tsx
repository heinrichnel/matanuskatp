...
const DieselDashboardComponent: React.FC = () => {
  ...
  const recentEntries = [
    { id: 'FL-1234', vehicle: 'TRK-101', liters: 150, cost: 217.50, date: '2023-07-21', location: 'Main Depot', driver: 'John Doe' },
    { id: 'FL-1233', vehicle: 'TRK-105', liters: 200, cost: 290.00, date: '2023-07-20', location: 'Highway Station', driver: 'Jane Smith' },
    { id: 'FL-1232', vehicle: 'TRK-103', liters: 175, cost: 253.75, date: '2023-07-19', location: 'City Gas', driver: 'Mike Johnson' },
    { id: 'FL-1231', vehicle: 'TRK-102', liters: 160, cost: 232.00, date: '2023-07-18', location: 'Main Depot', driver: 'Sarah Williams' },
    { id: 'FL-1230', vehicle: 'TRK-104', liters: 180, cost: 261.00, date: '2023-07-17', location: 'Rural Station', driver: 'David Brown' },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <label htmlFor="date-range" className="mr-2 font-medium">Date Range:</label>
          <select 
            id="date-range"
        ...
        <div className="flex space-x-2">
          ...
          <Link to="/diesel/analytics" className="bg-gray-100 text-gray-800 px-4 py-2 rounded-md hover:bg-gray-200">
            View Analytics
          </Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-lg shadow">
          ...
          <p className="text-2xl font-bold text-blue-600">{fuelData.totalLiters.toLocaleString()}</p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow">
          <h3 className="text-sm font-medium text-gray-500">Total Cost</h3>
          <p className="text-2xl font-bold text-red-600">${fuelData.totalCost.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow">
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          ...
          <p className="text-2xl font-bold text-green-600">${fuelData.savings.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-4 rounded-lg shadow">
          ...
          <p className="text-2xl font-bold text-blue-600">{fuelData.fuelEfficiency.toFixed(1)} km/L</p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow">
          <h3 className="text-sm font-medium text-gray-500">Avg. Consumption per Vehicle</h3>
          <p className="text-2xl font-bold text-blue-600">{fuelData.averagePerVehicle.toFixed(1)} L</p>
        </div>
        <div className="bg-white p-4 rounded-lg shadow">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Link to="/diesel/new" className="bg-blue-600 text-white py-2 px-3 rounded text-center hover:bg-blue-700">
              Add Fuel Entry
            </Link>
            <Link to="/diesel/fuel-cards" className="bg-gray-100 text-gray-800 py-2 px-3 rounded text-center hover:bg-gray-200">
              Manage Fuel Cards
            </Link>
            <Link to="/diesel/theft-detection" className="bg-gray-100 text-gray-800 py-2 px-3 rounded text-center hover:bg-gray-200">
              Fuel Theft Alerts
            </Link>
            <Link to="/diesel/stations" className="bg-gray-100 text-gray-800 py-2 px-3 rounded text-center hover:bg-gray-200">
              Fuel Stations
            </Link>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 border border-yellow-200 bg-yellow-50 rounded">
              ...
              <Link to="/diesel/alerts" className="text-blue-600 hover:underline text-sm">View</Link>
            </div>
            <div className="flex items-center justify-between p-3 border border-red-200 bg-red-50 rounded">
              ...
              <Link to="/diesel/theft-detection" className="text-blue-600 hover:underline text-sm">Investigate</Link>
            </div>
            <div className="flex items-center justify-between p-3 border border-green-200 bg-green-50 rounded">
              ...
              <Link to="/diesel/stations" className="text-blue-600 hover:underline text-sm">Details</Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <div className="flex justify-between items-center mb-4">
          ...
          <Link to="/diesel/logs" className="text-blue-600 hover:text-blue-800">View All</Link>
        </div>
