        ...
        <CardContent className="p-4">
          ...
          {anomalyReports.length === 0 ? (
            <div className="text-center text-gray-500 py-8">
              ...
              <p className="mt-1 text-sm text-gray-500">The system is monitoring for unusual fuel patterns.</p>
            </div>
          ) : (
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Detects unexpected decreases in fuel tank levels during periods of vehicle inactivity.
                This method uses IoT sensors to track fuel levels in real-time.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Identifies abnormal fuel consumption rates by comparing actual consumption with expected rates
                based on historical data, vehicle specifications, load, route, and weather conditions.
              </p>
            </div>
