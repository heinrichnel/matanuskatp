...
const InspectionForm: React.FC<InspectionFormProps> = ({
  ...
  const [formState, setFormState] = useState({
    ...
    inspectorSignature: existingInspection?.inspectorSignature || "",
    driverSignature: existingInspection?.driverSignature || "",
  });
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          <Button variant="outline" icon={<Save className="w-4 h-4" />} onClick={onClick}>
            Save Draft
          </Button>
          <Button
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <SignaturePad
              ...
              onChange={(signature) =>
                setFormState((prev) => ({ ...prev, inspectorSignature: signature }))
              }
              value={formState.inspectorSignature}
            ...
            <SignaturePad
              title="Driver/Operator Signature"
              onChange={(signature) =>
                setFormState((prev) => ({ ...prev, driverSignature: signature }))
              }
              value={formState.driverSignature}
              id="driver-signature"
              required
            />
          </div>
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg max-w-lg w-full p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-end space-x-3">
              ...
              <Button icon={<FileText className="w-4 h-4" />} onClick={onClick}>
                Create Job Card
              </Button>
            </div>
          </div>
