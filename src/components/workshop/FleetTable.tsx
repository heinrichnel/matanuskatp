...
// Mock fleet data
const mockFleetData = [
  { fleetNumber: '21H', registration: 'ADS4865', make: 'SCANIA', model: 'G460', chassisNo: '9BS56440003882656', engineNo: 'DC13106LO18271015', vehicleType: 'Truck', status: 'Active', odometer: 62000 },
  { fleetNumber: '22H', registration: 'ADS4866', make: 'SCANIA', model: 'G460', chassisNo: '9BSG6X40003882660', engineNo: 'DC13106LO18271019', vehicleType: 'Truck', status: 'Maintenance', odometer: 58000 },
  { fleetNumber: '23H', registration: 'AFQ1324', make: 'SHACMAN', model: 'X3000', chassisNo: 'LZGJL5V42MX011270', engineNo: '1421A006077', vehicleType: 'Truck', status: 'Active', odometer: 25000 },
  { fleetNumber: '24H', registration: 'AFQ1325', make: 'SHACMAN', model: 'X3000', chassisNo: 'LZGJL5V42MX011270', engineNo: '1421A006076', vehicleType: 'Truck', status: 'Active', odometer: 23000 },
  { fleetNumber: '26H', registration: 'AFQ1327', make: 'SHACMAN', model: 'X3000', chassisNo: 'LZGJL5V44MX011271', engineNo: '1421A006085', vehicleType: 'Truck', status: 'Active', odometer: 28000 },
  { fleetNumber: '28H', registration: 'AFQ1329', make: 'SHACMAN', model: 'X3000', chassisNo: 'LZGJL5V46MX011272', engineNo: '1421A006084', vehicleType: 'Truck', status: 'Active', odometer: 31000 },
  { fleetNumber: '31H', registration: 'AGZ1963', make: 'SHACMAN', model: 'X3000', chassisNo: 'LZGJL4W48PX122273', engineNo: '71129664', vehicleType: 'Truck', status: 'Active', odometer: 8000 }
];
...
const FleetTable: React.FC = () => {
  ...
  const handleSaveVehicle = async (fleet: any) => {
    ...
    if (editingFleet) {
      ...
      setFleetData(prev => prev.map(v => 
        v.fleetNumber === fleet.fleetNumber ? fleet : v
      ));
    } else {
      // Add new fleet
  ...
  const exportFleetData = () => {
    // Create CSV content
    let csv = 'Fleet Number,Registration,Make,Model,Chassis Number,Engine Number,Vehicle Type,Status,Odometer\n';
