    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Manage maintenance activities, work orders, and service schedules</p>
        </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <p className="mt-1 text-sm text-gray-500">Pending maintenance requests will appear here</p>
                <div className="mt-6">
                  <Button
                    icon={<Plus className="w-4 h-4" />}
                  >
        ...
        <TabsContent value="schedule" className="mt-6">
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                <h3 className="mt-2 text-sm font-medium text-gray-900">Service schedule module is under development</h3>
        ...
        <TabsContent value="inventory" className="mt-6">
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                <h3 className="mt-2 text-sm font-medium text-gray-900">Parts inventory module is under development</h3>
                <p className="mt-1 text-sm text-gray-500">This feature will be available soon</p>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="labor" className="mt-6">
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                <h3 className="mt-2 text-sm font-medium text-gray-900">Labor codes module is under development</h3>
                <p className="mt-1 text-sm text-gray-500">This feature will be available soon</p>
              </div>
            </CardContent>
          </Card>
        ...
        <TabsContent value="tasks" className="mt-6">
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                <h3 className="mt-2 text-sm font-medium text-gray-900">Task master module is under development</h3>
                <p className="mt-1 text-sm text-gray-500">This feature will be available soon</p>
              </div>
            </CardContent>
          </Card>
