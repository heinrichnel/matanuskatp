        ...
        <div>
            ...
            <div className="flex items-center">
              <div className="ml-3">
                ...
                <p className="text-sm text-blue-700">
                  Every cost entry must include either a receipt/document upload 
                  OR a valid explanation for missing documentation. Items 
                  without proper documentation will be automatically flagged 
                  for investigation.
                </p>
              </div>
            </div>
          ...
          <div className="mt-4">
            <label htmlFor="missingDocReason" className="block text-sm font-medium text-gray-700">
              Reason for Missing Documentation {!selectedFiles && <span className="text-red-500">*</span>}
            </label>
            <textarea
              id="missingDocReason"
            ...
            {!selectedFiles && (
              <p className="mt-1 text-xs text-amber-600 flex items-center">
                ...
                This entry will be automatically flagged for investigation due to missing documentation.
              </p>
            )}
          </div>
