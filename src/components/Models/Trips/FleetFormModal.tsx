...
const FleetFormModal: React.FC<FleetFormModalProps> = ({
  isOpen,
  onClose,
  fleet,
  onSave
  ...
  const [formData, setFormData] = useState<Partial<Fleet>>(fleet || {
    fleetNumber: '',
    registration: '',
    make: '',
    model: '',
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Input
            ...
            onChange={(value) => handleChange('assignedDriver', value)}
