          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div>
                ...
                <p className="text-blue-800">
                  {trip.clientName} ({trip.clientType})
                </p>
              </div>
            </div>
        ...
        <div className="space-y-4 border-t pt-4">
          ...
          <div className="bg-gray-50 p-4 rounded-md border border-gray-200">
            <p className="text-sm text-gray-600 mb-4">
              These dates will be used for final invoicing. Adjust if necessary to match the agreed
              timeline with the client.
            </p>
            ...
            <div className="mt-3 flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-600">
                  <p>
                    Planned Arrival:{" "}
                    {trip.plannedArrivalDateTime
                      ? new Date(trip.plannedArrivalDateTime).toLocaleString()
                      : "Not specified"}
                  </p>
                  <p>
                    Planned Offload:{" "}
                    {trip.plannedOffloadDateTime
                      ? new Date(trip.plannedOffloadDateTime).toLocaleString()
                      : "Not specified"}
                  </p>
                  <p>
                    Planned Departure:{" "}
                    {trip.plannedDepartureDateTime
                      ? new Date(trip.plannedDepartureDateTime).toLocaleString()
                      : "Not specified"}
                  </p>
                </div>
              </div>
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-gray-600">
                  <p>
                    Actual Arrival:{" "}
                    {trip.actualArrivalDateTime
                      ? new Date(trip.actualArrivalDateTime).toLocaleString()
                      : "Not recorded"}
                  </p>
                  <p>
                    Actual Offload:{" "}
                    {trip.actualOffloadDateTime
                      ? new Date(trip.actualOffloadDateTime).toLocaleString()
                      : "Not recorded"}
                  </p>
                  <p>
                    Actual Departure:{" "}
                    {trip.actualDepartureDateTime
                      ? new Date(trip.actualDepartureDateTime).toLocaleString()
                      : "Not recorded"}
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-4">
              ...
              {proofOfDeliveryFiles && proofOfDeliveryFiles.length > 0 && (
                <div className="mt-2 bg-green-50 border border-green-200 rounded p-2">
                  <p className="text-sm text-green-800 font-medium">
                    Selected {proofOfDeliveryFiles.length} file(s):
                  </p>
            ...
            <div>
              ...
              {signedInvoiceFiles && signedInvoiceFiles.length > 0 && (
                <div className="mt-2 bg-green-50 border border-green-200 rounded p-2">
                  <p className="text-sm text-green-800 font-medium">
                    Selected {signedInvoiceFiles.length} file(s):
                  </p>
                  <ul className="mt-1 text-sm text-green-700 list-inside list-disc">
        ...
        <div className="space-y-3 border-t pt-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
            <p className="text-sm text-blue-700">
              <strong>Note:</strong> Submitting for invoicing will mark this trip as ready for
              billing. The invoice data will be available for processing in the Invoice Management
              section.
            </p>
          </div>
        </div>
