        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Select
              ...
              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleFilterChange('riskLevel', e.target.value)}
              options={[
            ...
            <Select
              ...
              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleFilterChange('clientType', e.target.value)}
              options={[
