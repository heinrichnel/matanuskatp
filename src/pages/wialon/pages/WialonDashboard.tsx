...
const WialonDashboard: React.FC = () => {
  ...
  return (
    <div className="p-4">
      ...
      <div
        className={`mt-4 ${displayMode === "iframe" ? "bg-white dark:bg-gray-800 p-4 rounded shadow" : ""}`}
      >
        <WialonIntegration
      ...
      <div className="mt-6 mb-6 bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-500 p-4 text-sm">
        ...
        <p className="mt-1 text-blue-600 dark:text-blue-300">
          This integration uses a secure token to connect directly to your Wialon account. If you
          experience any issues with the connection, please contact your system administrator.
        </p>
      </div>
