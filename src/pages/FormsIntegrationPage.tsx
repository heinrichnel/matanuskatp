...
const FormsIntegrationPage: React.FC = () => {
  ...
  const showSuccessMessage = (form: 'fleet' | 'tyres' | 'routes' | 'inventory', message: string) => {
  ...
  const handleRouteSelection = (data: any) => {
    ...
    showSuccessMessage('routes', `Route from ${data.startLocation} to ${data.endLocation} planned successfully`);
  };
      ...
      <div className="bg-white shadow-md rounded-lg p-6">
        ...
        {activeTab === 'routes' && (
          <div>
            ...
            <RouteSelectionForm 
              onComplete={handleRouteSelection} 
              tripId="trip-123"
            />
          </div>
        )}
