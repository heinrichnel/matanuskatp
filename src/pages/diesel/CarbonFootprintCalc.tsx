...
import { Download, Leaf, Truck, BarChart2, Calendar } from 'lucide-react';
      ...
      <Card>
        <CardContent className="p-4">
          ...
          <div className="bg-gray-100 p-6 rounded-lg flex flex-col items-center justify-center h-64">
            <p className="text-gray-500">Bar chart showing emissions by vehicle type would appear here</p>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Fleet Count</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Total CO2 (tons)</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">CO2 per Vehicle</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Heavy Duty Trucks</td>
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Medium Duty Trucks</td>
                ...
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Light Delivery Vehicles</td>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 mb-2">
                  Potential CO2 reduction of 2.8 tons per month by optimizing routes to reduce distance traveled.
                </p>
              ...
              <div className="flex-1 border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 mb-2">
                  Estimated 1.5 tons CO2 savings through eco-driving techniques training for fleet drivers.
                </p>
                <Button size="sm">View Details</Button>
              </div>
