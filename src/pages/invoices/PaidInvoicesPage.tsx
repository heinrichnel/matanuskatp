...
const PaidInvoicesPage: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'issueDate',
      key: 'issueDate',
      sorter: (a: PaidInvoice, b: PaidInvoice) => new Date(a.issueDate).getTime() - new Date(b.issueDate).getTime(),
    },
    {
      title: 'Paid Date',
      dataIndex: 'paidDate',
      key: 'paidDate',
      sorter: (a: PaidInvoice, b: PaidInvoice) => new Date(a.paidDate).getTime() - new Date(b.paidDate).getTime(),
    },
    {
      ...
      onFilter: (value: string, record: PaidInvoice) => record.paymentMethod === value,
    },
    {
      title: 'Reference #',
    ...
    },
    {
      title: 'Actions',
      key: 'actions',
      render: (text: string, record: PaidInvoice) => (
        <Space size="small">
