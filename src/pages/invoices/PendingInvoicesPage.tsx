  ...
  const getStatusTag = (status: string) => {
    switch (status) {
      case 'awaiting_approval':
        return <Tag color="orange"><ClockCircleOutlined /> Awaiting Approval</Tag>;
      case 'awaiting_payment':
        return <Tag color="blue"><CheckOutlined /> Approved, Awaiting Payment</Tag>;
      default:
  ...
  const columns = [
    {
      ...
      key: 'invoiceNumber',
      sorter: (a: PendingInvoice, b: PendingInvoice) => a.invoiceNumber.localeCompare(b.invoiceNumber),
    },
    {
      title: 'Client',
      dataIndex: 'client',
    ...
    },
    {
      ...
      dataIndex: 'issueDate',
      key: 'issueDate',
      sorter: (a: PendingInvoice, b: PendingInvoice) => new Date(a.issueDate).getTime() - new Date(b.issueDate).getTime(),
    },
    {
      title: 'Due Date',
      dataIndex: 'dueDate',
      key: 'dueDate',
      sorter: (a: PendingInvoice, b: PendingInvoice) => new Date(a.dueDate).getTime() - new Date(b.dueDate).getTime(),
    },
    {
      title: 'Status',
      dataIndex: 'status',
            ...
            return (
              <>
                <Table.Summary.Row>
                  ...
                  <Table.Summary.Cell index={2}><Text strong>${totalAmount.toFixed(2)}</Text></Table.Summary.Cell>
