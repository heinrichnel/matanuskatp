                ...
                <tr key={driver.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    <div className="flex items-center">
                      <div className={`h-8 w-8 rounded-full flex items-center justify-center mr-2 ${
                        driver.safetyScore >= 90 ? 'bg-green-100 text-green-800' :
                        driver.safetyScore >= 80 ? 'bg-blue-100 text-blue-800' :
                        driver.safetyScore >= 70 ? 'bg-yellow-100 text-yellow-800' :
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full
                      ${driver.riskLevel === 'Low' ? 'bg-green-100 text-green-800' :
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {driver.incidents === 0 ? (
                      <span className="inline-flex items-center text-green-700">
                        <CheckCircle className="w-4 h-4 mr-1" />None
                      </span>
                    ) : (
                      <span className="inline-flex items-center text-red-700">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full
                      ${driver.trainingStatus === 'Complete' ? 'bg-green-100 text-green-800' :
                        driver.trainingStatus === 'Due' ? 'bg-yellow-100 text-yellow-800' :
                        'bg-red-100 text-red-800'
                      }`}>
