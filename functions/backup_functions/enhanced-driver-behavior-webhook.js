...
exports.importDriverBehaviorWebhook = exports.enhancedDriverBehaviorWebhook = void 0;
 ...
 */
exports.enhancedDriverBehaviorWebhook = (0, https_1.onRequest)(async (req, res) => {
    // --- CORS & Method Guard ---
    ...
    if (!(requestBody === null || requestBody === void 0 ? void 0 : requestBody.events) || !Array.isArray(requestBody.events)) {
        res.status(400).json({
 ...
 */
exports.importDriverBehaviorWebhook = exports.enhancedDriverBehaviorWebhook;
//# sourceMappingURL=enhanced-driver-behavior-webhook.js.map